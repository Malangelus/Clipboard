...
import (
	...
	"net/http"
	"os"
	"sebs.software/Malangelus/Clipboard/client"
	"sebs.software/Malangelus/Clipboard/tool/cli"
	"time"
)
...
func main() {
	...
	app := &cobra.Command{
		Use:   "Clipboard-cli",
		Short: `CLI client for the Clipboard service`,
	}
